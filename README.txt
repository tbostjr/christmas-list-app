...
This file is a template for creating Node.js web applications with support for MySQL databases. 
...
NPM Packages:
	npm i --save express, express-handlebars, debug, dotenv, config, mysql, knex, lodash, morgan, bootstrap, jquery, bootswatch, moment, cookie-parser, jsonwebtoken, bcrypt 
